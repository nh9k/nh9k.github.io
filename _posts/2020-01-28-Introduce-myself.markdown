...
Another topic of my research is image classification, detection, segmentation and tracking objects which uses at robots, autonomous driving car and drones, etc(Real-World Problems).
...
<ol>
  ...
  <li> Study OS(Operating System)<a href="https://www.slideshare.net/ssuserf5270f/os-study-mindmapnanheekim">PPTLink</a></li>
</ol>
